...
const Task = () => {
  ...
  return (
    <div>
      {!auth ? (
        <h2 style={{ color: "white" }}>404 Error: Page not found</h2>
      ) : (
        todo
          ...
          .map((item) => (
            <div>
              ...
              <Grid className="taskTitle">
                <h1
                  style={{
                    textDecoration: `${item.status ? "line-through" : "none"} `,color:"#0066ff"
                  }}
                >
                  {item.title}
                </h1>
              ...
              <div className="taskTitle">
                ...
                >
                  <AlertDialog
                    label={"Edit"}
                    value={`Previouse Text was: [ ${item.des} ]`}
                    name="des"
                    handleChange={handleChange}
                    handleSuccessMessage={handleSuccessMessage}
                  />
              ...
              <fieldset className="fieldset">
                <legend style={{ color: "red", fontSize: "20px" }}>
                  Sub Tasks
                </legend>
                {item.subtask?.map((sTask, index) => (
                  <div className="sub-task" key={index}>
                    ...
                    >
                      <AlertDialog
                        label={"Edit"}
                        value={`Previouse Text was: [ ${sTask} ]`}
                        index={index}
                        name="subtask"
                        handleChange={handleChange}
                        handleSuccessMessage={handleSuccessMessage}
