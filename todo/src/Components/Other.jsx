...
const Other = () => {
    ...
    return (
        ...
        (other === 0) ? <div style={{ display: 'flex', justifyContent: 'center', flexDirection: 'column',
        ...
        (<div className="dashboard">
            <div className="mainCard">
                ...
                {todo?.filter(item=>item.todo === "todo" && item.other).map((item)=>(
            ...
            <div className="mainCard">
                ...
                {todo?.filter(item=>item.todo === "inProcess" && item.other).map((item)=>(
                    <Card {...item} deleteHandler={deleteHandler}
                    statusHandler={statusHandler}/>
                ))}
            </div>
            ...
            <div className="mainCard">
                ...
                {todo?.filter(item=>item.todo === "done" && item.other).map((item)=>(
                    <Card {...item} deleteHandler={deleteHandler}
                    statusHandler={statusHandler}/>
                ))}
            </div>
